...
<td><input type="text" class="textbox" id="email" name="email" value="${form.email}" /></td>
</tr>
<tr align = "left">
<td><label>Username: </label></td>
<td><input type="text" class="textbox" id="username" name="userName" value="${form.userName}" /></td>
</tr>
<tr align = "left">
...
<td><input type="password" class="textbox" id="confirmpassword" name="confirm" value="" /></td>
</tr>
<tr>
<td></td>
