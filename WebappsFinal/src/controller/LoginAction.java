 ...
 * requested bookmark.  If there was no bookmark originally requested
...
public class LoginAction extends Action {
    ...
    public String perform(HttpServletRequest request) {
        ...
        try {
	        ...
	        // original request only if the user is just trying to view a bookmark.
	        ...
	        if (request.getParameter("button").equals("New User")) {
	            return "register_empty_form.jsp";
	        }
	        ...
	        // Look up the user
	        User user = userDAO.lookup(form.getEmail());
